    ...
    if (new Date() - global.db.data.users[m.sender].lastngepet > 18000000) {
      ...
      if (Aku > Kamu) {
        conn.sendMessage(
          m.chat,
          {
            image: { url: "https://telegra.ph/file/c6c4a6946a354317fe970.jpg" },
        ...
        conn.sendMessage(
          m.chat,
          {
            image: { url: "https://telegra.ph/file/6a6a440d7f123bed78263.jpg" },
        ...
        conn.sendMessage(
          m.chat,
          `Maaf kamu tidak mendapatkan *Duit* dan kamu tidak masuk Dunia Lain karna melarikan diri\n${botol}`,
          m,
        );
        global.db.data.users[m.sender].lastngepet = new Date() * 1;
      }
      ...
      conn.sendMessage(
        m.chat,
        {
          image: { url: "https://telegra.ph/file/295949ff5494f3038f48c.jpg" },
