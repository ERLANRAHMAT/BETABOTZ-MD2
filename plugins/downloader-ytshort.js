var handler = async (m, {conn, text, usedPrefix}) => {
  ...
  try {
    var vid = `https://yt.tioo.eu.org/youtube?url=${text}&filter=audioandvideo&quality=highestvideo&contenttype=video/mp4`
    var aud = `https://yt.tioo.eu.org/youtube?url=${text}&filter=audioonly&quality=highestaudio&contenttype=audio/mpeg` 
