...
let handler = async (m, {
  ...
  if (command == 'ffstalk') {
    ...
    try {
      let ff = await fetch(API('lann', '/api/stalk/ff', { id: text, apikey: lann })).then(res => res.json());
    ...
    try {
      let ml = await fetch(API('lann', '/api/stalk/ml', { id: id, server: server, apikey: lann })).then(res => res.json());
  ...
  if (command == 'supersusstalk') {
    ...
    try {
      let sus = await fetch(API('lann', '/api/stalk/supersus', { id: text, apikey: lann })).then(res => res.json());
  ...
  if (command == 'npmstalk') {
    ...
    try {
        let npm = await fetch(API('lann', '/api/stalk/npm', { name: text, apikey: lann })).then(res => res.json());      
 ...
 if (command == 'repostalk') {
    ...
    try {
      let repo = await fetch(API('lann', '/api/stalk/repo', { repo: text, apikey: lann })).then(res => res.json());
