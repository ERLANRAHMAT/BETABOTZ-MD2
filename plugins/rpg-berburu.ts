let handler: WaPlugin = async (m, { conn }) => {
    ...
    if (Date.now() - global.db.data.users[m.sender].lastberburu > 3600000) {
        ...
        let rbrb1 = (+randomaku1)
        let rbrb2 = (+randomaku2)
        let rbrb3 = (+randomaku3)
        let rbrb4 = (+randomaku4)
        let rbrb5 = (+randomaku5)
        let rbrb6 = (+randomaku6)
        let rbrb7 = (+randomaku7)
        let rbrb8 = (+randomaku8)
        let rbrb9 = (+randomaku9)
        let rbrb10 = (+randomaku10)
        let rbrb11 = (+randomaku11)
        let rbrb12 = (+randomaku12)
