...
- Free apikey botcahx hanya 100 limit per day jika ingin memiliki limit lebih silahkan registrasi terlebih dahulu, lalu chat bot saya [botcahx](http://wa.me/62813958616959?text=.claimtrial )
...
[`ID /`](https://github.com/ERLANRAHMAT/BETABOTZ-MD2/blob/pro/README.md)[`EN`](https://github.com/ERLANRAHMAT/BETABOTZ-MD2/blob/pro/ENGLISH.md)
